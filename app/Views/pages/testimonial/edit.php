                    ...
                    <div class="modal-body">
                            <form  class="row" enctype='multipart/form-data' id="modal_form">
                                <div class="form-group col-sm-12">
                                    ...
                                    <input type="hidden" name="old_gambar" value="<?= $data['gambar_pendaftar'] ?>">
                                    <input type="text" class="form-control" name="nama_pendaftar" value="<?= $data['nama_pendaftar'] ?>">
                                </div>
                                <div class="form-group col-sm-12">
                                    <label for="kategori">Testimoni</label>
                                    <textarea id="" class="form-control" name="testimoni" rows="3"><?= $data['testimoni'] ?></textarea>
                                </div>
                                <div id="option2Content" class="form-group col-sm-12">
                                    ...
                                    <br>
                                        ...
                                        <img src="/img/testimonial/<?= $data['gambar_pendaftar']?>" id="blah" width="100" alt=""  class="mb-5">
                                        <br>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="<?= base_url('testimonial')?>" class="btn btn-secondary" data-dismiss="modal">Kembali</a>
                            </form>
                            </div>
                        </div>
                    </div>
    ...
    $("#modal_form").submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                else if(response.errors.nama_pendaftar){
                    toastr.error(response.errors.nama_pendaftar);
                }else if(response.errors.testimoni){
                    toastr.error(response.errors.testimoni);
                }else{
                    toastr.error(response.errors.gambar_pendaftar);
                }
